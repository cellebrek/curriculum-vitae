...
},{"./modules/main/module":17,"backbone":"backbone","backbone.marionette":"backbone.marionette","jquery":"jquery"}],14:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"../models/article":16,"backbone":"backbone"}],15:[function(require,module,exports){
var Backbone = require('backbone');
var Marionette = require('backbone.marionette');
...
},{"../../../datas.json":1,"./collections/articles":14,"./views/cover/cover":20,"./views/footer/footer":22,"./views/header/header":24,"backbone":"backbone","backbone.marionette":"backbone.marionette"}],16:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"./controller":15,"./router":18,"./views/layout/layout":26,"backbone.marionette":"backbone.marionette"}],18:[function(require,module,exports){
var Marionette = require('backbone.marionette');
...
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "	<article class=\"blog-preview__article\" data-id=\""
    + alias3(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"id","hash":{},"data":data}) : helper)))
    + "\">\n\n"
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.slider : depth0),{"name":"if","hash":{},"fn":this.program(2, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "\n		<div class=\"blog-preview__article-description\">\n			<h2 class=\"blog-preview__article-title\">"
    + alias3(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"title","hash":{},"data":data}) : helper)))
    + "</h2>\n			<div class=\"blog-preview__article-content\">"
    ...
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.gallery : depth0),{"name":"if","hash":{},"fn":this.program(5, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "\n	</article>\n";
},"2":function(depth0,helpers,partials,data) {
    var stack1;

  return "			<ul class=\"slider\" data-slider>\n"
    + ((stack1 = helpers.each.call(depth0,(depth0 != null ? depth0.slider : depth0),{"name":"each","hash":{},"fn":this.program(3, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "			</ul>\n";
},"3":function(depth0,helpers,partials,data) {
    var helper, alias1=helpers.helperMissing, alias2="function", alias3=this.escapeExpression;

  return "					<li class=\"slider__item slide\" data-slider-item>\n						<div class=\"slider__item-information\">\n							<h2 class=\"slider__item-title slider__item-text\">"
    + alias3(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"title","hash":{},"data":data}) : helper)))
    + "</h2>\n							<div class=\"slider__item-label slider__item-text\">"
    ...
    + "\" alt=\"\" class=\"slider__item-image\" width=\"100%\">\n					</li>\n";
},"5":function(depth0,helpers,partials,data) {
    var stack1;

  return "			<div class=\"gallery\">\n				<ul class=\"gallery__list\" data-gallery>\n"
    + ((stack1 = helpers.each.call(depth0,(depth0 != null ? depth0.gallery : depth0),{"name":"each","hash":{},"fn":this.program(6, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "				</ul>\n			</div>\n";
},"6":function(depth0,helpers,partials,data) {
    var helper, alias1=helpers.helperMissing, alias2="function", alias3=this.escapeExpression;

  return "						<li class=\"gallery__item\"><a href=\""
    + alias3(((helper = (helper = helpers.full || (depth0 != null ? depth0.full : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"full","hash":{},"data":data}) : helper)))
    + "\"><img src=\""
    + alias3(((helper = (helper = helpers.thumb || (depth0 != null ? depth0.thumb : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"thumb","hash":{},"data":data}) : helper)))
    + "\" alt=\"\" width=\"100%\"></a></li>\n";
...
},{"./cover.hbs":19,"backbone.marionette":"backbone.marionette","magnific-popup":11,"slick-carousel":12}],21:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "<div class=\"footer__item\">\n    <h5>NAVIGATION</h5>\n    <ul class=\"footer__item-content footer__item-menu\">\n        <li><a href=\"#\">Home</a></li>\n        <li><a href=\"#\">Work</a></li>\n        <li><a href=\"#\">Directors</a></li>\n        <li><a href=\"#\">News</a></li>\n        <li><a href=\"#\">About</a></li>\n        <li><a href=\"#\">Contact</a></li>\n    </ul>\n</div>\n\n<div class=\"footer__item\">\n    <h5>LOCATION</h5>\n    <div class=\"footer__item-content\">\n        <p>48 Beak Street<br>London<br>W1F 9RL</p>\n    </div>\n</div>\n\n<div class=\"footer__item\">\n    <h5>CONTACT</h5>\n    <div class=\"footer__item-content\">\n        <span>Jason Mitchelle</span><br><span>CEO</span><br><a href=\"mailto:jason.mitchelle27@example.com\">e: jason.mitchelle27@example.com</a>\n    </div>\n</div>\n\n<div class=\"footer__item\">\n    <h5>NEWSLETTER</h5>\n    <form action=\"./\" method=\"post\">\n        <input type=\"email\" name=\"email\">\n        <input type=\"submit\" value=\"SUBMIT\" class=\"btn\">\n    </form>\n</div>";
},"useData":true});
...
},{"./footer.hbs":21,"backbone.marionette":"backbone.marionette"}],23:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "<div class=\"header__cover\">\n	<h1 class=\"header__logo\">FilmCo.</h1>	\n</div>\n\n<nav class=\"header__nav\">\n	<ul>\n	    <li class=\"header__nav-item\"><a href=\"#\">WORK</a></li>\n	    <li class=\"header__nav-item\"><a href=\"#\">DIRECTORS</a></li>\n	    <li class=\"header__nav-item\"><a href=\"#\">NEWS</a></li>\n	    <li class=\"header__nav-item\"><a href=\"#\">ABOUT</a></li>\n	    <li class=\"header__nav-item\"><a href=\"#\">CONTACT</a></li>\n	</ul>\n</nav>\n";
},"useData":true});
...
},{"./header.hbs":23,"backbone.marionette":"backbone.marionette","jquery":"jquery"}],25:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"./layout.hbs":25,"backbone.marionette":"backbone.marionette"}]},{},[13]);
